 ...
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2009-11-01}List" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Lists {
    ...
    protected java.util.List<com.pch.bm.amazon.ws.List> list;
     ...
     * {@link com.pch.bm.amazon.ws.List }
     * 
     * 
     */
    public java.util.List<com.pch.bm.amazon.ws.List> getList() {
        if (list == null) {
            list = new ArrayList<com.pch.bm.amazon.ws.List>();
        }
        return this.list;
    }
