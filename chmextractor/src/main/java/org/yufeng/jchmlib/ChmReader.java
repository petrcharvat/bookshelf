...
public class ChmReader {
    ...
    public static void extractOne(ChmManager cm,FileEntry fe,String savef) {
        byte[][]tmp=cm.retrieveObject(fe);//"/mini.GIF");///java/awt/CardLayout.html");///java/awt/AWTEvent.html");///javalogo52x88.gif");////test.html");//"/test.html");//"/
        writeFile(tmp,savef);
    }
    ...
    public static void extractOne(ChmManager cm,String htmlf,String savef) {
        byte[][]tmp=cm.retrieveObject(htmlf);//"/mini.GIF");///java/awt/CardLayout.html");///java/awt/AWTEvent.html");///javalogo52x88.gif");////test.html");//"/test.html");/
        writeFile(tmp,savef);
